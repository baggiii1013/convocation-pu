...
import { Award, Calendar, ChevronDown, MapPin } from "lucide-react";
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 text-center bg-gradient-to-b from-background to-background/90">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gold/5 rounded-full blur-3xl animate-float-delayed" />
